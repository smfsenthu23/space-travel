...
function Planets ()
{
  ...
  {
    // to set the selected spacecraft
    // to send spacecraft to planet using the API
    // to call getPlanetsWithSpacecrafts to refresh the page content
